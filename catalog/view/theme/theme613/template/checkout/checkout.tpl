		...
		<div class="row box checkout_form">
			...
			<div class="row">
				  ...
				  <div class="form-group col-md-6 hidden">
				    ...
				    <input type="text" name="fax" value="" placeholder="<?php echo str_replace(':','',$entry_fax); ?>" id="input-payment-fax" class="form-control" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
				  </div>
				  <?php //}?>
			    ...
			    <?php if (isset($customer_id)) {?>	  
				  ...
				  <div class="form-group col-md-12 hidden">
				    ...
				    <input type="text" name="address_2" value="" placeholder="<?php echo str_replace(':','',$entry_address_2); ?>" id="input-payment-address-2" class="form-control" />
				  </div>
				  <div class="form-group required col-md-6">
				  ...
				  <div class="form-group required col-md-6 hidden">
				    ...
				    <input type="text" name="postcode" value="" placeholder="<?php echo str_replace(':','',$entry_postcode); ?>" id="input-payment-postcode" class="form-control" />
				  </div>
				</div>
				...
				<div class="your_order">
					...
					<div class="radio">
					  <label>
					    ...
					    <input type="radio" name="payment_method" value="cod" title="<?php echo $payment_method['title']; ?>" checked="checked" />
