      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
		  ...
		  <div class="form-group hidden">
            ...
            <div class="col-sm-10">
              <input type="text" name="bank_name" value="" placeholder="<?php echo $entry_bank_name; ?>" id="input-bank-name" class="form-control" />
            </div>
          </div>
		  <div class="form-group hidden">
            <label class="col-sm-2 control-label" for="input-iban"><?php echo $entry_iban; ?></label>
            <div class="col-sm-10">
              <input type="hidden" name="iban" value="" placeholder="<?php echo $entry_iban; ?>" id="input-iban" class="form-control" />
            </div>
          </div>
		  <div class="form-group hidden">
            <label class="col-sm-2 control-label" for="input-swift-bic"><?php echo $entry_swift_bic; ?></label>
            <div class="col-sm-10">
              <input type="hidden" name="swift_bic" value="" placeholder="<?php echo $entry_swift_bic; ?>" id="input-swift-bic" class="form-control" />
            </div>
          </div>
		  <div class="form-group hidden">
            <label class="col-sm-2 control-label" for="input-tax-id"><?php echo $entry_tax_id; ?></label>
            <div class="col-sm-10">
              <input type="hidden" name="tax_id" value="" placeholder="<?php echo $entry_tax_id; ?>" id="input-tax-id" class="form-control" />
            </div>
          </div>
		   <div class="form-group hidden">
            <label class="col-sm-2 control-label" for="input-bank-address"><?php echo $entry_bank_address; ?></label>
            <div class="col-sm-10">
              <input type="hidden" name="bank_address" value="" placeholder="<?php echo $entry_bank_address; ?>" id="input-bank-address" class="form-control" />
            </div>
          </div>
		  <div class="form-group required hidden">
            ...
            <div class="col-sm-10">
              <input type="hidden" name="paypal" value="" placeholder="<?php echo $entry_paypal; ?>" id="input-paypal" class="form-control" />
              <?php if ($error_paypal) { ?>
          ...
          <div class="form-group required">
            ...
            <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?></label>
            <div class="col-sm-10">
              <input type="tel" name="telephone_n" value="<?php echo $telephone_n; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" />
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-10">
              <input type="hidden" name="fax" value="" placeholder="<?php echo $entry_fax; ?>" id="input-fax" class="form-control" />
            </div>
          </div>
        </fieldset>
        <fieldset id="address">
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-10">
              <input type="text" name="company" value="default" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" />
          ...
          <div class="form-group required hidden">
            ...
            <div class="col-sm-10">
              <input type="hidden" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="form-control" />
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-10">
              <input type="hidden" name="address_2" value="" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
          ...
          <div class="form-group required hidden">
            ...
            <div class="col-sm-10">
              <input type="hidden" name="postcode" value="" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" />
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-10">
              <input type="hidden" name="store_url" value="" placeholder="<?php echo $entry_store_url; ?>" id="input-store-url" class="form-control" />
            </div>
          </div>
		  <div class="form-group hidden">
