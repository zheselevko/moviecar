...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseStart: function(event) {
		...
		//The element's absolute position on the page blog_minus margins
		...
		$.extend(this.offset, {
			...
			relative: this._getRelativeOffset() //This is a relative to absolute position blog_minus the actual position calculation - only used for relative positioned helper
		});
