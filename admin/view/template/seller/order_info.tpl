          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <select name="order_product_status_id" id="input-order-status" class="form-control">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <li><a href="#tab-sellerhistory" data-toggle="tab"><?php echo $tab_sellerhistory; ?></a></li>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-sellerhistory">
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-sellernotify"><?php echo $entry_sellernotify; ?></label>
                  <div class="col-sm-10">
                    <input type="checkbox" name="sellernotify" value="1" id="input-sellernotify" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-sellercomment"><?php echo $entry_comment; ?></label>
                  <div class="col-sm-10">
                    <textarea name="sellercomment" rows="8" id="input-sellercomment" class="form-control"></textarea>
                  </div>
                </div>
              </form>
            </fieldset>
            <div class="text-right">
              <button id="button-sellerhistory" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_history_add; ?></button>
            </div>
...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/createinvoiceno&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/addreward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/removereward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/addcommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/removecommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$('#history').load('index.php?route=sale/order/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>');
...
$('#button-history').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		url: '<?php echo $store_url; ?>index.php?route=api/order/history&token=' + token + '&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#sellerhistory').load('index.php?route=seller/order/sellerhistory&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>');

$('#button-sellerhistory').on('click', function() {

	$.ajax({
		url: 'index.php?route=seller/order/sellerhistoryadd&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>',
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'sellernotify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0)  + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'sellercomment\']').val()),
		beforeSend: function() {
...
$('#button-sellersettlementhistory').on('click', function() {
   if(typeof verifyStatusChange == 'function'){
 	...
 	$.ajax({
 		url: 'index.php?route=seller/order/sellerordersettlement&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>',
 		type: 'post',
 		dataType: 'json',
