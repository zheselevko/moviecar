...
<?php echo $column_left; ?>
	<div id="content">
		...
		<div class="panel-heading">
			...
			<a class="btn btn-success btn-xs pull-right" href="https://opencartforum.com/index.php?app=core&module=search&do=user_activity&search_app=downloads&mid=12381" target="_blank">Смотреть другие модули</a>
		</div>
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-seogen" class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="seogen_profile"><?php echo $text_profiles?></label>
						...
						<div class="col-sm-1">
							<button onclick="delProfile()" class="btn btn-primary btn-block" type="button"><?php echo $text_delete?></button>
						</div>
						<div class="col-sm-2"><input type="text" name="seogen_profile_name" class="form-control"></div>
						<div class="col-sm-1">
							<button onclick="addProfile()" class="btn btn-primary btn-block" type="button"><?php echo $text_add?></button>
						</div>
				</div>	
				<div class="form-group" id="including">
					<label class="col-sm-1 control-label"><span data-toggle="tooltip" title="<?php echo $help_category; ?>"><?php echo $entry_category; ?></span></label>
					<div class="col-sm-3">
					...
					<label class="col-sm-1 control-label"><span data-toggle="tooltip" title="<?php echo $help_manufacturer; ?>"><?php echo $entry_manufacturer; ?></span></label>
					<div class="col-sm-3">
						<div class="well well-sm" style="height: 205px; overflow: auto;">
				...
				<div class="tab-content">
					<div class="tab-pane active in" id="tab-categories">
						...
						<div class="form-group">
							<div class="col-sm-6">
								<button onclick="generate('categories');" class="btn btn-primary pull-left" type="button"><?php echo $text_generate; ?></button>
							</div>
							<div class="col-sm-6">
									<label class="control-label">
									    <span data-toggle="tooltip" title="<?php echo $help_rewrite_start; ?>"><?php echo $entry_overwrite ?></span>
									</label>
							</div>
						</div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_categories_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_categories_meta_h1_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[categories_meta_h1_overwrite]" <?php if(isset($seogen['categories_meta_h1_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_categories_meta_title_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[categories_meta_title_overwrite]" <?php if(isset($seogen['categories_meta_title_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_categories_meta_keyword_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_categories_meta_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<div class="checkbox">
									<label>
									    <input type="checkbox" name="seogen[categories_use_expressions]" <?php if(isset($seogen['categories_use_expressions'])) echo "checked='checked'"; ?> class="form-control">
									</label>
								</div>
							</div>
						</div>
                        ...
                        <div class="col-sm-4">
                                <textarea class="summernote" id="categories_description_template" cols="125" rows="2" name="seogen[categories_description_template]"><?php echo $seogen['categories_description_template']; ?></textarea>
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_categories_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <button onclick="generate('products');" class="btn btn-primary pull-left" type="button"><?php echo $text_generate; ?></button>
                        </div>
                        <div class="col-sm-6">
                            <label class="control-label"><?php echo $entry_overwrite ?></label>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[products_meta_h1_overwrite]" <?php if(isset($seogen['products_meta_h1_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_meta_title_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[products_meta_title_overwrite]" <?php if(isset($seogen['products_meta_title_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_meta_keyword_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_meta_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                <textarea class="summernote" id="products_description_template" cols="125" rows="2" name="seogen[products_description_template]"><?php echo $seogen['products_description_template']; ?></textarea>
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_tag_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_products_model_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="checkbox">
									<label>
										<input type="checkbox" name="seogen[products_use_expressions]" <?php if(isset($seogen['products_use_expressions'])) echo "checked='checked'"; ?> class="form-control">
									</label>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane fade" id="tab-manufacturers">
						<div class="form-group">
							<div class="col-sm-6">
								<button onclick="generate('manufacturers');" class="btn btn-primary pull-left" type="button"><?php echo $text_generate; ?></button>
							</div>
							<div class="col-sm-6">
									<label class="control-label"><?php echo $entry_overwrite ?></label>
							</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_manufacturers_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_manufacturers_meta_h1_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[manufacturers_meta_h1_overwrite]" <?php if(isset($seogen['manufacturers_meta_h1_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_manufacturers_meta_title_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[manufacturers_meta_title_overwrite]" <?php if(isset($seogen['manufacturers_meta_title_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_manufacturers_meta_keyword_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_manufacturers_meta_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                <textarea class="summernote" id="manufacturers_description_template" cols="125" rows="2" name="seogen[manufacturers_description_template]"><?php echo $seogen['manufacturers_description_template']; ?></textarea>
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_manufacturers_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="checkbox">
									<label>
										<input type="checkbox" name="seogen[manufacturers_use_expressions]" <?php if(isset($seogen['manufacturers_use_expressions'])) echo "checked='checked'"; ?> class="form-control">
								   </label>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane fade" id="tab-informations">
						<div class="form-group">
							<div class="col-sm-6">
								<button onclick="generate('informations');" class="btn btn-primary pull-left" type="button"><?php echo $text_generate; ?></button>
							</div>
							<div class="col-sm-6">
									<label class="control-label"><?php echo $entry_overwrite ?></label>
							</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_informations_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_informations_meta_h1_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[informations_meta_h1_overwrite]" <?php if(isset($seogen['informations_meta_h1_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_informations_meta_title_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                            <input class="overwrite" type="checkbox" name="seogen[informations_meta_title_overwrite]" <?php if(isset($seogen['informations_meta_title_overwrite'])) echo "checked='checked'"; ?>>
                        </div>
						</div>
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_informations_meta_keyword_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                ...
                                <span class="help-block"><?php echo $text_available_tags . '<b> ' . $text_informations_meta_description_tags . '</b>'; ?></span>
                        </div>
                        <div class="col-sm-4">
