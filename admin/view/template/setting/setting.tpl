            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group required">
               ...
               <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone3" value="<?php echo $config_telephone3; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" />
                  <?php if ($error_telephone) { ?>
                  <div class="text-danger"><?php echo $error_telephone; ?></div>
                  <?php } ?>
                </div>
               ...
               <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone4" value="<?php echo $config_telephone4; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" />
                  <?php if ($error_telephone) { ?>
                  <div class="text-danger"><?php echo $error_telephone; ?></div>
                  <?php } ?>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-comment-product"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_comment_new; ?>"><?php echo $entry_comment_new; ?></span></label>
                <div class="col-sm-10">
                  <textarea name="config_comment_new" rows="5" placeholder="<?php echo $entry_comment_new; ?>" id="input-comment-product" class="form-control"><?php echo $config_comment_new; ?></textarea>
                </div>
              </div>
              <?php if ($locations) { ?>
              <div class="form-group">
