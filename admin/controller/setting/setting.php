...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_comment_new'] = $this->language->get('entry_comment_new');
		...
		if (isset($this->request->post['config_comment_new'])) {
			$data['config_comment_new'] = $this->request->post['config_comment_new'];
		} else {
			$data['config_comment_new'] = $this->config->get('config_comment_new');
		}
